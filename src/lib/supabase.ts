...
// Proyecto de producción. La llave publishable es pública por diseño (va dentro de la página de todos modos);
...
const PROYECTO_ANON_KEY = 'sb_publishable_I8Z8TLs0TXQg59GuJ2LkiA_pJSPiRZ1';
